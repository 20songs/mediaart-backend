...
contract MediaartAuction is MediaartOwnership {
...
*/
        ...
        whenNotPaused
    {
        ...
        // because it will be owned by the auction contract.
        require(_owns(msg.sender, _mediaartId));
        require(isReadyToBreed(_mediaartId));
        _approve(_mediaartId, siringAuction);
